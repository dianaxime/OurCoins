...
class AboutActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val toggle = ActionBarDrawerToggle(
            this, drawerabout, toolbar, R.string.navigation_drawer_open, R.string.navigation_drawer_close
        )
        drawerabout.addDrawerListener(toggle)
        toggle.syncState()

        navabout.setNavigationItemSelectedListener(this)
    }
    override fun onBackPressed() {
        if (drawerabout.isDrawerOpen(GravityCompat.START)) {
