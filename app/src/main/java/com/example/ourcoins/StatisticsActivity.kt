...
class StatisticsActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val toggle = ActionBarDrawerToggle(
            this, drawerstatistics, toolbar, R.string.navigation_drawer_open, R.string.navigation_drawer_close
        )
        drawerstatistics.addDrawerListener(toggle)
        toggle.syncState()
    ...
    override fun onBackPressed() {
        if (drawerstatistics.isDrawerOpen(GravityCompat.START)) {
